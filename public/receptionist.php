...
<div class="row" style="width: 100%;">
  <div class="col-1">
    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      ...
      <!-- <a class="nav-link" id="v-pills-set-schedule-tab" data-toggle="pill" href="#v-pills-set-schedule" role="tab" aria-controls="v-pills-set-schedule" aria-selected="true">
  ...
  <div class="col-11">
    ...
    <div class="tab-content" id="v-pills-tabContent">
      ...
      <!-- <div class="tab-pane fade" id="v-pills-set-schedule" role="tabpanel" aria-labelledby="v-pills-set-schedule-tab">
        <?php // include_once('receptionist-components/set_schedule.php'); ?>
      </div> -->
